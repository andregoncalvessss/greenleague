...
export default function CampanhasBackoffice() {
  ...
  const totalPaginas = Math.ceil(filtradas.length / CAMPANHAS_PER_PAGE);
  const filtradasPagina = filtradas.slice(pagina * CAMPANHAS_PER_PAGE, (pagina + 1) * CAMPANHAS_PER_PAGE);
